...
public final class Constants {
    public static final class SpeedScaleFactors{
        public static double SwerveMaxSpeed = 1.0; //Speed in percentage

        //Speeds for arms and shooter
    ...
    public static final class DriveConstants {
        ...
        public static final double kFrontLeftDriveAbsoluteEncoderOffsetDeg = 116.894531;//11
        public static final double kBackLeftDriveAbsoluteEncoderOffsetDeg = -103.447266;//10
        public static final double kFrontRightDriveAbsoluteEncoderOffsetDeg = 165.146484;//12
        public static final double kBackRightDriveAbsoluteEncoderOffsetDeg = -66.972656;//9
